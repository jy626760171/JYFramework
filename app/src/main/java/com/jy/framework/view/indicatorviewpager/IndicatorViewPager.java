package com.jy.framework.view.indicatorviewpager;
...
import com.jy.framework.base.fragment.FragmentListPageAdapter;
...
import com.jy.framework.view.indicatorviewpager.viewpager.RecyclingPagerAdapter;
import com.jy.framework.view.indicatorviewpager.viewpager.SViewPager;
...
public class IndicatorViewPager {
	...
	public IndicatorViewPager(Indicator indicator, ViewPager viewPager) {
		this(indicator, viewPager, null);

	}

	public IndicatorViewPager(Indicator indicator, ViewPager viewPager, OnIndicatorPageChangeListener listener) {
		super();
