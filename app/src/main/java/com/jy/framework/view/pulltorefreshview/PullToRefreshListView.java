...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> implements OnClickListener {
	...
	public ListView createListView(Context context, AttributeSet attrs, TypedArray a) {
		TypedArray aa = context.obtainStyledAttributes(attrs, R.styleable.PullToRefresh);
	...
	@Override
	protected ListView createRefreshableView(Context context, AttributeSet attrs, TypedArray a) {
