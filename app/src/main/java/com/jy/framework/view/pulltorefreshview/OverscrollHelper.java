...
public final class OverscrollHelper {
	 ...
	 *            - Threshold for which the values how fuzzy we should treat the other values. Needed for WebView as it doesn't always scroll back to it's edge. 0 = no fuzziness.
	 * @param scaleFactor
